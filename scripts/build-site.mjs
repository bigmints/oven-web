...
await writeFile(
  ...
  layout(
    ...
    config.description,
    "",
    `<main id="main"><section class="hero wrap"><div class="hero-copy"><span class="eyebrow"><span class="dot"></span> YOUR MAC. MORE POSSIBILITIES.</span><h1>Good apps.<br>Less <em>setup.</em></h1><p class="hero-description">Thoughtfully chosen apps for your everyday life. Get organized, make something, learn a little, and make your Mac more useful.</p><div class="hero-actions">${download("Get Oven for Mac")}<a class="text-link" href="#apps">Find your next app <span aria-hidden="true">↓</span></a></div><p class="fine">A local home for your apps. Made for people and their agents.</p></div><div class="hero-art" aria-label="A collection of useful apps"><div class="orbit orbit-one"></div><div class="orbit orbit-two"></div><span class="art-caption">A FEW OF YOUR NEXT FAVORITES</span>${catalog.apps
      .slice(0, 5)
      .map(
        (a, i) =>
